...
export default function Navbar({scroll,aboutmeRef,contactRef,skillsRef,homeRef}) {
      ...
      <div className="relative flex h-16 items-center justify-between">
        ...
        <div className="flex items-center">
          <div className="shrink-0 ">
            <a className=' text-custom-blue rounded-md px-3 py-2 text-xl font-extrabold font-jak'><span className='text-white'>Med</span>nas</a>
          </div>
        </div> 
