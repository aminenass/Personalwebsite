    ...
    <div ref={contactRef} id="contact-section">
      {result === "Form Submitted Successfully" ? (
        <div className="pb-24 sm:pb-32 flex sm:flex-row flex-col sm:justify-around flex-wrap items-center ">
          <div
            href="#"
            className="bg-stone-800 rounded-xl max-w-sm flex flex-col sm:flex-row items-center flex-wrap mt-16 "
          >
            <div className="my-10 mx-12 ">
              <div className="text-center text-stone-700 text-2xl font-semibold flex justify-center items-center flex-col">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="#058ED9"
                  className="size-32 sm:size-40 mb-2"
                >
                  <path
                    strokeLinecap="round"
                ...
                <h5 className="font-Poppins text-3xl sm:text-4xl font-semibold tracking-tight text-white  mb-4">
                  Success !
                </h5>
                <p className="font-normal text-white/75 text-lg sm:text-xl">
                  {result}
                </p>
                <div className="mt-6">
                  <button
        ...
        <div className=" px-6 pb-24 sm:pb-32 lg:px-8 bg-gradient-to-t from-transparent via-stone-800/50 to-darkish/50 ">
      ...
      {result && result !== "Form Submitted Successfully" && (
        <div className="pb-24 sm:pb-32 flex px-6 sm:flex-row flex-col sm:justify-around flex-wrap items-center ">
          <div
            href="#"
            className="bg-stone-800 rounded-xl max-w-sm flex flex-col sm:flex-row items-center flex-wrap "
          >
            <div className="my-10 mx-12 ">
              <div className="text-center text-stone-700 text-2xl font-semibold flex justify-center items-center flex-col">
                <h5 className="font-Poppins text-3xl sm:text-4xl font-semibold tracking-tight text-red-600  mb-4">
                  {result}
                </h5>
              </div>
            </div>
